...
public class BeforeMessage extends AppCompatActivity implements TextToSpeech.OnInitListener,TextToSpeech.OnUtteranceCompletedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Thread logoTimer = new Thread() {
            public void run() {
                try {
                    try {
                        sleep(1000);
                        speakWords("Say any alphabet after Tapping on the screen ");
        ...
        logoTimer.start();
        tvvs=new TextToSpeech(BeforeMessage.this,BeforeMessage.this);
...
//                ContextCompat.getColor(this, R.color.color2)
    ...
    private void showResults(Bundle results) {
        ...
        {
            Intent intent=new Intent(BeforeMessage.this,Message.class);
        ...
        {
            Intent intent=new Intent(BeforeMessage.this,contacts2.class);
            intent.putExtra("alphabet",a);
            startActivity(intent);
        }
...
//                myTTS = new TextToSpeech(this, this);
    ...
    public void onUtteranceCompleted(String utteranceId) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(BeforeMessage.this, "COMPLETED", Toast.LENGTH_SHORT).show();
                recognitionProgressView.play();
    ...
    public boolean onKeyLongPress(int keycode,KeyEvent event){
        if(keycode==KeyEvent.KEYCODE_VOLUME_UP){
            startActivity(new Intent(BeforeMessage.this,MyLocationGetter.class));
            return true;
        }
